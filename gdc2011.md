...
- [Notes from GDC 2021](#notes-from-gdc-2021)
  ...
  - [Automated Testing Roundtable Day 1: Process](#automated-testing-roundtable-day-1-process)
    ...
    - [Raw Notes:](#raw-notes-14)
      - [How does QA department "sit" within different departments? How is QA included in processes?](#how-does-qa-department-sit-within-different-departments-how-is-qa-included-in-processes)
        - [Asker's biggest takeaway: create a framework where QA can write their own tests.](#askers-biggest-takeaway-create-a-framework-where-qa-can-write-their-own-tests)
      - [Performance testing and metrics, instrumented markers. Interested in gathering and comparative analysis. What issues do you have to get reliable perf metrics?](#performance-testing-and-metrics-instrumented-markers-interested-in-gathering-and-comparative-analysis-what-issues-do-you-have-to-get-reliable-perf-metrics)
        - [Asker's biggest takeaway: Like the idea of running something pretty often. Trying to make sure it doesn't get lost in the high iteration rate. Like the idea of limiting scale and increasing frequency. Perhaps signal evens out with greater amount of data.](#askers-biggest-takeaway-like-the-idea-of-running-something-pretty-often-trying-to-make-sure-it-doesnt-get-lost-in-the-high-iteration-rate-like-the-idea-of-limiting-scale-and-increasing-frequency-perhaps-signal-evens-out-with-greater-amount-of-data)
      - [Pre-submission tests](#pre-submission-tests)
        - [Asker's biggest takeaway: trusting the muscle memory of the user. My instinct was to try to figure out what has changed. Breaking apart the tests is something that I have seen, but that's a challenge to know how to break them apart will do this on a new project starting up.](#askers-biggest-takeaway-trusting-the-muscle-memory-of-the-user-my-instinct-was-to-try-to-figure-out-what-has-changed-breaking-apart-the-tests-is-something-that-i-have-seen-but-thats-a-challenge-to-know-how-to-break-them-apart-will-do-this-on-a-new-project-starting-up)
      - [Strategies to get dev team invested in the automated tests.](#strategies-to-get-dev-team-invested-in-the-automated-tests)
        - [Asker's biggest takeaway: go to Henry's talk on Thursday. Need to get people invested on their own terms.](#askers-biggest-takeaway-go-to-henrys-talk-on-thursday-need-to-get-people-invested-on-their-own-terms)
      - [How to get automation implemented early enough on to get savings down the road, due to tests not being a short-term development.](#how-to-get-automation-implemented-early-enough-on-to-get-savings-down-the-road-due-to-tests-not-being-a-short-term-development)
        - [Asker's biggest takeaway: start small but smart, early.](#askers-biggest-takeaway-start-small-but-smart-early)
      - [What sort of tools are available for automated testing on target devices?](#what-sort-of-tools-are-available-for-automated-testing-on-target-devices)
        - [Asker's biggest takeaway: expose hooks for game to be used. We use nUnit as the harness and then a device farm in house.](#askers-biggest-takeaway-expose-hooks-for-game-to-be-used-we-use-nunit-as-the-harness-and-then-a-device-farm-in-house)
      - [Automated reporting that is correctly noisy. Too many notifications start to get ignored.](#automated-reporting-that-is-correctly-noisy-too-many-notifications-start-to-get-ignored)
        - [Asker's biggest takeaway: stay in communication with those recieving notifications to find how to tune the summary.](#askers-biggest-takeaway-stay-in-communication-with-those-recieving-notifications-to-find-how-to-tune-the-summary)
  - [Technical Issues in Tools Development Roundtable Day 1: Assets](#technical-issues-in-tools-development-roundtable-day-1-assets)
    ...
    - [Raw Notes](#raw-notes-15)
      - [Survey of what is used in version control. P4? Git with LFS?](#survey-of-what-is-used-in-version-control-p4-git-with-lfs)
      - [On version control, anything in terms of integration into your tools](#on-version-control-anything-in-terms-of-integration-into-your-tools)
      - [How assets are stored and maintained](#how-assets-are-stored-and-maintained)
      - [Trasitive dependency tracking, sometimes something will change many layers away and how do you know? Dependencies that depend on other dependencies, and whether data is stale.](#trasitive-dependency-tracking-sometimes-something-will-change-many-layers-away-and-how-do-you-know-dependencies-that-depend-on-other-dependencies-and-whether-data-is-stale)
      - [Open source libraries or framework?](#open-source-libraries-or-framework)
      - [How many people like or prefer using integrated version control?](#how-many-people-like-or-prefer-using-integrated-version-control)
      - [Scripting, programmers write code in C++, looking to turn those scripts into an asset. What does your scripting system for engine look like?](#scripting-programmers-write-code-in-c-looking-to-turn-those-scripts-into-an-asset-what-does-your-scripting-system-for-engine-look-like)
      - [How to transition between visual scripting and transition this back to c++ code, or vice versa](#how-to-transition-between-visual-scripting-and-transition-this-back-to-c-code-or-vice-versa)
  - [Tools Design Roundtable Day 1: Design](#tools-design-roundtable-day-1-design)
    - [TL;DR:](#tldr-15)
    - [Summary](#summary-16)
    - [Raw Notes](#raw-notes-16)
      - [How many need to support more than one language in scripting: studio uses both japanese and english. We know we want to support both, but do not have the time to do everything.](#how-many-need-to-support-more-than-one-language-in-scripting-studio-uses-both-japanese-and-english-we-know-we-want-to-support-both-but-do-not-have-the-time-to-do-everything)
      - [Keeping tools lean, moving to a smaller studio where we have to pick our battles. Need to pick features that won't die when abandoned. Knowing when to say no and which ones make sense.](#keeping-tools-lean-moving-to-a-smaller-studio-where-we-have-to-pick-our-battles-need-to-pick-features-that-wont-die-when-abandoned-knowing-when-to-say-no-and-which-ones-make-sense)
      - [How to instill design culture when there is team flux](#how-to-instill-design-culture-when-there-is-team-flux)
      - [When people start thinking about UX](#when-people-start-thinking-about-ux)
      - [Strategies in switching hotkeys in editors](#strategies-in-switching-hotkeys-in-editors)
      - [Prototyping in general for a workflow](#prototyping-in-general-for-a-workflow)
  ...
  - [Automated Testing Roundtable Day 2: Legacy](#automated-testing-roundtable-day-2-legacy)
    ...
    - [Raw Notes](#raw-notes-19)
      - [Horror story at my org around bad solutions, where the scope of what you are testing grew and fell over](#horror-story-at-my-org-around-bad-solutions-where-the-scope-of-what-you-are-testing-grew-and-fell-over)
      - [Going to start a new game, tips on leaving a good legacy](#going-to-start-a-new-game-tips-on-leaving-a-good-legacy)
        - [Takeaways: Wasn't what I was expecting to hear. Assumed I don't have to talk to people because things are automated, right? Sounds like it is the other way around!](#takeaways-wasnt-what-i-was-expecting-to-hear-assumed-i-dont-have-to-talk-to-people-because-things-are-automated-right-sounds-like-it-is-the-other-way-around)
      - [Experience with tests that are flaky and unreliable, frameworks or mitigations](#experience-with-tests-that-are-flaky-and-unreliable-frameworks-or-mitigations)
      - [testing in mobile games](#testing-in-mobile-games)
        - [Takeaways: Keep tests isolated and small, use lower level API as well as sanity tests. Don't rely on full playback tests at the UI level across the product.](#takeaways-keep-tests-isolated-and-small-use-lower-level-api-as-well-as-sanity-tests-dont-rely-on-full-playback-tests-at-the-ui-level-across-the-product)
      - [Comparing screenshots](#comparing-screenshots)
      - [How have things changed being remote for a year?](#how-have-things-changed-being-remote-for-a-year)
  ...
  - [Interviewing for Design Roundtable Day 1](#interviewing-for-design-roundtable-day-1)
    ...
    - [Raw Notes](#raw-notes-21)
      - [How to build a protfolio when there isn't an established track record of working on a specific game or type of game. May not have the resources to copy or show that you understand a specific design space. Is there a more universal project that can show this off?](#how-to-build-a-protfolio-when-there-isnt-an-established-track-record-of-working-on-a-specific-game-or-type-of-game-may-not-have-the-resources-to-copy-or-show-that-you-understand-a-specific-design-space-is-there-a-more-universal-project-that-can-show-this-off)
      - [How can we best interview for design when there isn't established design expertise or design culture? (perhaps a question on establishing design culture) Similar to AJ question about in-group bias.](#how-can-we-best-interview-for-design-when-there-isnt-established-design-expertise-or-design-culture-perhaps-a-question-on-establishing-design-culture-similar-to-aj-question-about-in-group-bias)
      - [What questions aren't appropriate to ask as an interviewee?](#what-questions-arent-appropriate-to-ask-as-an-interviewee)
        - [Questions **to** ask:](#questions-to-ask)
      - [A lot of jobs ask for AAA shipped titles. What jobs should I look at to get the experience ball rolling?](#a-lot-of-jobs-ask-for-aaa-shipped-titles-what-jobs-should-i-look-at-to-get-the-experience-ball-rolling)
      - [What are portfolio trends you like or are tired of](#what-are-portfolio-trends-you-like-or-are-tired-of)
      - [How to set yourself apart, what about the unreal kit where it's up to the designer to put it together](#how-to-set-yourself-apart-what-about-the-unreal-kit-where-its-up-to-the-designer-to-put-it-together)
  - [Technical Issues in Tools Development Roundtable Day 2: Pipeline](#technical-issues-in-tools-development-roundtable-day-2-pipeline)
    ...
    - [Raw Notes](#raw-notes-22)
      - [What is the difference between game CI and other CI?](#what-is-the-difference-between-game-ci-and-other-ci)
      - [Sharing tools and patterns between teams or projects, where is the line between a tool being "reusable" and "not built here"](#sharing-tools-and-patterns-between-teams-or-projects-where-is-the-line-between-a-tool-being-reusable-and-not-built-here)
      - [Hardware problems around latency, minimize technical issues around huge builds and running out of space.](#hardware-problems-around-latency-minimize-technical-issues-around-huge-builds-and-running-out-of-space)
      - [Using open source in your pipeline](#using-open-source-in-your-pipeline)
      - [Developing tools for many different devices, porting tools across target platforms](#developing-tools-for-many-different-devices-porting-tools-across-target-platforms)
  ...
  - [Automated Testing Roundtable Day 3: Implementation](#automated-testing-roundtable-day-3-implementation)
    ...
    - [Raw Notes](#raw-notes-25)
      - [What systems do you use? Jenkins?](#what-systems-do-you-use-jenkins)
      - [For those with NDAs, are you using public device farms or on-premises? Safety considerations?](#for-those-with-ndas-are-you-using-public-device-farms-or-on-premises-safety-considerations)
      - [Complexity with amount of devices - XBox, Playstation device farm.](#complexity-with-amount-of-devices---xbox-playstation-device-farm)
      - [New drivers for GPUs, etc, how do you test all the variation?](#new-drivers-for-gpus-etc-how-do-you-test-all-the-variation)
      - [Introducing testing culture to new teammates](#introducing-testing-culture-to-new-teammates)
  - [Technical Issues in Tools Development Roundtable Day 3: Workflow](#technical-issues-in-tools-development-roundtable-day-3-workflow)
    ...
    - [Raw Notes](#raw-notes-26)
      - [Debug tools, those can send information from one group to another group. Binding of debug data.](#debug-tools-those-can-send-information-from-one-group-to-another-group-binding-of-debug-data)
      - [What UI libraries like ImGui or web/WPF type tools? (poll of 27 people in attendance)](#what-ui-libraries-like-imgui-or-webwpf-type-tools-poll-of-27-people-in-attendance)
      - [What do people do to judge workflow quality](#what-do-people-do-to-judge-workflow-quality)
      - [How to sunset tools](#how-to-sunset-tools)
