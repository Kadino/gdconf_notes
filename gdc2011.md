...
- [Notes from GDC 2021](#notes-from-gdc-2021)
  ...
  - [AI Summit: Your Buddy, the Grandmaster: Repurposing Gameplaying AI for Inclusivity](#ai-summit-your-buddy-the-grandmaster-repurposing-gameplaying-ai-for-inclusivity)
    - [TL;DR: Include optional game-playing AI to assist players outside your core audience](#tldr-include-optional-game-playing-ai-to-assist-players-outside-your-core-audience)
    - [Summary](#summary-8)
  ...
  - [An Open Source Foundation for the Game Industry Roundtable](#an-open-source-foundation-for-the-game-industry-roundtable)
    - [TL;DR: Open source is growing in importance and steering committies/foundations make them work at scale.](#tldr-open-source-is-growing-in-importance-and-steering-committiesfoundations-make-them-work-at-scale)
    - [Summary](#summary-18)
...
### TL;DR: Grab bag of advice on how interviewees and interviewers should prepare a for design interview.
### Summary
...
Geoff Evans
### TL;DR: CI Pipelines are an incredibly useful and expensive magic: log metrics, reuse and share tools wherever possible, and be careful about licenses.
### Summary
...
### TL;DR: The complexities of making automated input-replay tests function: more bugs were found, though neither time nor money was saved.
### Summary
...
### TL;DR: Rely on user personas to focus scenario-based testing where it matters, and reduce focus on low-yield regression tests.
### Summary
...
Andrew Fray, Lead Programmer at Roll7
### TL;DR: Configuration-as-code minimizes maintenance. Start small but log aggressively. Talk with console manufacturers about legally farming tests onto their devices.
### Summary
...
Geoff Evans, Tools Engineer at Epic Games
### TL;DR: Good tool workflows are both extremely valuable and difficult (expensive) to deliver, with no silver bullet.
### Summary
...
### TL;DR: Collect metrics about your app performance, and alarm when they break a sane threshold.
### Summary
...
### TL;DR: Significant player engagement benefit from shifting away from public test servers into a 'testing grounds' feature fully-integrated into the game.
### Summary
...
### TL;DR: How a producer can help their team.
### Summary
...
### TL;DR: Microtalks: Virtual Pets, Indies in Japan, Dismantling Racism, Work/Life Balance as an RPG, Serverless Social Networks, Better Representation, Dynamics and Pacing, "Indie" Describes Developers not Games, and Keeping a Community Alive.
### Summary
